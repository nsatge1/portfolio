        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <aside className="md:sticky md:top-10 md:h-fit md:self-start">
            ...
            <p className="text-gray-300 leading-relaxed">
              Actuellement à la recherche d&rsquo;un <strong>stage de fin d&rsquo;études en cybersécurité (à partir de septembre 2025)</strong>, je souhaite m&rsquo;investir sur des missions touchant à la sécurité applicative, la protection des infrastructures ou la conformité réglementaire.
            </p>
          ...
          <section id="about" className="scroll-mt-32">
            ...
            <p className="text-sm text-gray-300 leading-relaxed">
              Je suis étudiant en dernière année d&rsquo;ingénierie en cybersécurité dans le cadre d&rsquo;un <strong>double diplôme</strong> entre l&rsquo;<strong>ENSEIRB-MATMECA (INP Bordeaux)</strong> et l&rsquo;<strong>Université du Québec à Chicoutimi (UQAC)</strong>.<br /><br />
              Durant mon année d&rsquo;échange au Canada, j&rsquo;ai combiné ma formation technique avec une expérience enrichissante en tant qu&rsquo;<strong>étudiant-athlète</strong> en <strong>cross-country</strong> et <strong>athlétisme</strong>, tout en cultivant ma passion pour le <strong>trail running</strong>, que je pratique depuis deux ans sur des épreuves longues distances (type UTMB).<br /><br />
              Mon parcours s&rsquo;articule autour de la <strong>sécurisation des systèmes d&rsquo;information</strong> : API sécurisées, réseaux Zero Trust, audits techniques, mais aussi conformité réglementaire (RGPD, ISO 27001, NIST). J&rsquo;ai eu l&rsquo;opportunité d&rsquo;intervenir sur des projets allant de la <strong>cybersécurité réseau</strong> à la <strong>protection des données en base</strong>, avec une approche systémique et orientée solution.<br /><br />
              Mes expériences en entreprise (Arkéa, INRIA) et en enseignement universitaire à l&rsquo;UQAC m&rsquo;ont permis d&rsquo;affiner à la fois mes compétences techniques, mon sens de la pédagogie et ma capacité à travailler en environnement multiculturel.<br /><br />
              Je suis actuellement à la recherche d&rsquo;un <strong>stage de fin d&rsquo;études en cybersécurité</strong> à partir de septembre 2025, avec un intérêt particulier pour les sujets mêlant sécurité applicative, infrastructure cloud, DevSecOps ou audit.
            </p>
          </section>
